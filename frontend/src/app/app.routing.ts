...
const routes: Routes = [
    {path: 'home', canActivate: [AuthGuardService], loadChildren: () => import('./pages/home/home.module').then(m => m.HomeModule)},
    ...
    {path: 'mobile', canActivate: [AuthGuardService], pathMatch: 'prefix', loadChildren: () => import('./mobile.module').then(m => m.MobileModule)},
    {path: 'table', canActivate: [AuthGuardService],loadChildren: () => import('./pages/table/table.module').then(m => m.TableModule)},
    {path: 'tv', canActivate: [AuthGuardService], pathMatch: 'prefix', loadChildren: () => import('./pages/tv/tv.module').then(m => m.TvModule)},
